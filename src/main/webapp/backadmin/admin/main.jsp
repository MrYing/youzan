...
<script type="text/javascript">
	...
	function openTab(text,url,iconCls){
		if($("#tabs").tabs("exists",text)){
			...
			var content="<iframe frameborder=0 scrolling='auto' style='width:100%;height:100%' src='${pageContext.request.contextPath}/backadmin/admin/"+url+"'></iframe>";
			$("#tabs").tabs("add",{
				title:text,
				iconCls:iconCls,
				closable:true,
...
<div region="center">
	<div class="easyui-tabs" fit="true" border="false" id="tabs">
		<div title="首页" data-options="iconCls:'icon-home'">
			<div align="center" style="padding-top: 100px"><font color="red" size="10">欢迎使用尚果微信商城后台管理系统</font></div>
		</div>
	</div>
</div>
