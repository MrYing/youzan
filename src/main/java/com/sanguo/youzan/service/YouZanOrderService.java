...
public class YouZanOrderService {
	...
	public Map<String, T_trade> getTradeOrderInfo(String tradeNum, String status, String start_created){
        ...
        while(it.hasNext()){
        	...
        	trader.setPay_type(tradesData.getString("pay_type"));
        	...
        	trader.setReceiver_address(tradesData.getString("receiver_address"));
        	...
        	trader.setShipping_type(tradesData.getString("shipping_type"));
	...
	public DeliveryOrder getDeliveryOrderInfo(Map<String, T_trade> TradeOrderMap){
    	...
    	for(Map.Entry<String, T_trade> entry : TradeOrderMap.entrySet()){
    		...
    		deliveryOrder.setOrderTime(trade.getCreated());
    		...
    		deliveryOrder.setReceiverName(trade.getReceiver_mobile());
